export function calculateRelativeChange(fromAvg, toAvg) {
...
export function analyzeSparklineMomentum(points) {
    ...
    if (turningUp)
        momentumMessage = 'Momentum recovering';
    else if (turningDown)
        momentumMessage = 'Momentum tapering';
    else if (bothGrowing && accelerating)
        momentumMessage = 'Accelerating growth';
    else if (bothGrowing)
        momentumMessage = 'Sustained growth';
    else if (bothDeclining && decelerating)
        momentumMessage = 'Accelerating decline';
    else if (bothDeclining)
        momentumMessage = 'Gradual decline';
    else if (accelerating)
        momentumMessage = 'Gaining momentum';
    else if (decelerating)
        momentumMessage = 'Growth stabilizing';
    else if (isGrowing)
        momentumMessage = 'Upward trend';
    else if (isDecreasing)
        momentumMessage = 'Downward trend';
    return {
        changeFirst,
        changeSecond,
        overallChange,
